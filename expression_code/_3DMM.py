...
#f = h5py.File("../../../tesi/3DMM_code/other_data.h5", "w")
...
class _3DMM:
    ...
    #def matrix_for_estimate_pose(self, id_landmarks_3D, avgModel):
     #   m_est_pose = np.ndarray(shape=(0,3))
      #  for i in range(id_landmarks_3D.shape[1]):
       #     index_row = id_landmarks_3D[0,i]
        #    new_row = avgModel[index_row-1,:]
         #   m_est_pose = np.vstack([m_est_pose, new_row])
        #return m_est_pose
